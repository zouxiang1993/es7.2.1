        ...
        private class InternalAsyncFetch extends AsyncShardFetch<NodeGatewayStartedShards> {
            ...
            void finish() {
                ...
                for (Response fetchResponse : fetchResponses) {
                    ImmutableOpenIntMap<List<IndicesShardStoresResponse.StoreStatus>> indexStoreStatuses =
                    ...
                    List<IndicesShardStoresResponse.StoreStatus> storeStatuses = indexShardsBuilder
