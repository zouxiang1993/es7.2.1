...
public class Suggest implements Iterable<Suggest.Suggestion<? extends Entry<? extends Option>>>, Writeable, ToXContentFragment {
    ...
    public <T extends Suggestion<? extends Entry<? extends Option>>> T getSuggestion(String name) {
        if (suggestions.isEmpty() || name == null) {
          ...
          return (T) (name.equals(suggestions.get(0).name) ? suggestions.get(0) : null);
            ...
            for (Suggestion<? extends Entry<? extends Option>> item : suggestions) {
    ...
    public static List<Suggestion<? extends Entry<? extends Option>>> reduce(Map<String, List<Suggestion>> groupedSuggestions) {
     ...
     */
    public abstract static class Suggestion<T extends Entry> implements Iterable<T>, NamedWriteable, ToXContentFragment {
        ...
        protected static <E extends Entry<?>> void parseEntries(XContentParser parser, Suggestion<E> suggestion,
