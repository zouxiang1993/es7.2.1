...
public class FloatNestedSortingTests extends DoubleNestedSortingTests {
    ...
    @Override
    protected XFieldComparatorSource createFieldComparator(String fieldName, MultiValueMode sortMode,
    ...
    protected void assertAvgScoreMode(Query parentFilter, IndexSearcher searcher,
                                            XFieldComparatorSource innerFieldComparator) throws IOException {
