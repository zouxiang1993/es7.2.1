...
public class LegacyGeoShapeFieldTypeTests extends FieldTypeTestCase {
    ...
    /**
     * Test for {@link GeoShapeFieldType#setStrategy(SpatialStrategy)} that checks
     * that {@link GeoShapeFieldType#pointsOnly()} gets set as a side effect when using SpatialStrategy.TERM
     */
