...
public class NumberFieldTypeTests extends FieldTypeTestCase {
    ...
    public void pickType() {
        type = RandomPicks.randomFrom(random(), NumberType.values());
    }

    @Override
    protected MappedFieldType createDefaultFieldType() {
        return new NumberFieldType(type);
    }
    ...
    public void testLongTermsQueryWithDecimalPart() {
        MappedFieldType ft = new NumberFieldType(NumberType.LONG);
        ft.setName("field");
        ft.setIndexOptions(IndexOptions.DOCS);
    ...
    public void testByteTermQueryWithDecimalPart() {
        MappedFieldType ft = new NumberFieldType(NumberType.BYTE);
        ft.setName("field");
        ft.setIndexOptions(IndexOptions.DOCS);
    ...
    public void testShortTermQueryWithDecimalPart() {
        MappedFieldType ft = new NumberFieldType(NumberType.SHORT);
        ft.setName("field");
        ft.setIndexOptions(IndexOptions.DOCS);
        assertTrue(ft.termQuery(42.1, null) instanceof MatchNoDocsQuery);
    }
    ...
    public void testRangeQueryWithNegativeBounds() {
        MappedFieldType ftInt = new NumberFieldType(NumberType.INTEGER);
        ftInt.setName("field");
        ...
        MappedFieldType ftLong = new NumberFieldType(NumberType.LONG);
    ...
    public void testDisplayValue() {
        ...
        assertEquals(Byte.valueOf((byte) 3),
                new NumberFieldType(NumberType.BYTE).valueForDisplay(3));
        assertEquals(Short.valueOf((short) 3),
                new NumberFieldType(NumberType.SHORT).valueForDisplay(3));
        assertEquals(Integer.valueOf(3),
                new NumberFieldType(NumberType.INTEGER).valueForDisplay(3));
        assertEquals(Long.valueOf(3),
                new NumberFieldType(NumberType.LONG).valueForDisplay(3L));
        assertEquals(Double.valueOf(1.2),
                new NumberFieldType(NumberType.HALF_FLOAT).valueForDisplay(1.2));
        assertEquals(Double.valueOf(1.2),
                new NumberFieldType(NumberType.FLOAT).valueForDisplay(1.2));
        assertEquals(Double.valueOf(1.2),
                new NumberFieldType(NumberType.DOUBLE).valueForDisplay(1.2));
    }
