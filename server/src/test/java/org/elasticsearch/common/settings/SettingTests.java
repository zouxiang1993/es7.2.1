...
public class SettingTests extends ESTestCase {
    ...
    public void testByteSizeSettingValidation() {
        ...
        SettingUpdater<ByteSizeValue> settingUpdater = byteSizeValueSetting.newUpdater(value::set, logger);
    ...
    public void testMemorySize() {
        ...
        AtomicReference<ByteSizeValue> value = new AtomicReference<>(null);
        SettingUpdater<ByteSizeValue> settingUpdater = memorySizeValueSetting.newUpdater(value::set, logger);
        try {
            settingUpdater.apply(Settings.builder().put("a.byte.size", 12).build(), Settings.EMPTY);
            fail("no unit");
    ...
    public void testSimpleUpdate() {
        ...
        SettingUpdater<Boolean> settingUpdater = booleanSetting.newUpdater(atomicBoolean::set, logger);
    ...
    public void testUpdaterIsIsolated() {
        ...
        SettingUpdater<Boolean> settingUpdater = booleanSetting.newUpdater(ab1::set, logger);
    ...
    public void testComplexType() {
        ...
        SettingUpdater<ComplexType> settingUpdater = setting.newUpdater(ref::set, logger);
    ...
    public void testGroups() {
        ...
        SettingUpdater<Settings> settingUpdater = setting.newUpdater(ref::set, logger);
        ...
        SettingUpdater<Settings> predicateSettingUpdater = setting.newUpdater(ref::set, logger,(s) -> assertFalse(true));
        try {
    ...
    public void testComposite() {
        ...
        SettingUpdater<Tuple<Integer, Integer>> settingUpdater = Setting.compoundUpdater(c::set, c::validate, a, b, logger);
        assertFalse(settingUpdater.apply(Settings.EMPTY, Settings.EMPTY));
        assertNull(c.a);
        assertNull(c.b);
    ...
    public void testListSettings() {
        ...
        SettingUpdater<List<String>> settingUpdater = listSetting.newUpdater(ref::set, logger);
    ...
    public void testSettingsGroupUpdater() {
        ...
        SettingUpdater<Settings> updater = Setting.groupedSettingsUpdater(s -> {},
