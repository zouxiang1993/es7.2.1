...
public class HighlighterSearchIT extends ESIntegTestCase {
    ...
    public void testGlobalHighlightingSettingsOverriddenAtFieldLevel() {
        ...
        SearchSourceBuilder source = searchSource()
                ...
                .highlighter(highlight().order("score").preTags("<global>").postTags("</global>").fragmentSize(1).numOfFragments(1)
                        .field(new Field("field1").numOfFragments(2))
                        .field(new Field("field2").preTags("<field2>").postTags("</field2>")
    ...
    public void testDisableFastVectorHighlighter() throws Exception {
        ...
        search = client().prepareSearch()
                .setQuery(matchPhraseQuery("title", "test for the workaround"))
                .highlighter(
                        new HighlightBuilder().field(new Field("title").highlighterType("plain")).highlighterType(
                                "plain"))
                .get();
    ...
    public void testPlainHighlightDifferentFragmenter() throws Exception {
        ...
        SearchResponse response = client().prepareSearch("test")
                ...
                .highlighter(
                        new HighlightBuilder().field(new Field("tags")
        ...
        SearchResponse response = client().prepareSearch("test")
                ...
                .highlighter(
                        new HighlightBuilder().field(
                                new Field("field1").preTags("<1>").postTags("</1>").requireFieldMatch(true)).field(
                                new Field("field2").preTags("<2>").postTags("</2>").requireFieldMatch(false)))
                .get();
    ...
    public void testMissingStoredField() throws Exception {
        ...
        SearchResponse response = client().prepareSearch("test")
            ...
            .highlighter(
                new HighlightBuilder().field(new Field("highlight_field").fragmentSize(-1).numOfFragments(1)
