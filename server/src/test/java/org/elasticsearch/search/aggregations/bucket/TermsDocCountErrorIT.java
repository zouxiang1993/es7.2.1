...
public class TermsDocCountErrorIT extends ESIntegTestCase {
    ...
    private void assertDocCountErrorWithinBounds(int size, SearchResponse accurateResponse, SearchResponse testResponse) {
        ...
        for (Bucket testBucket : testBuckets) {
            ...
            Bucket accurateBucket = accurateTerms.getBucketByKey(testBucket.getKeyAsString());
        ...
        for (Bucket accurateBucket: accurateTerms.getBuckets()) {
            assertThat(accurateBucket, notNullValue());
            Bucket testBucket = accurateTerms.getBucketByKey(accurateBucket.getKeyAsString());
            if (testBucket == null) {
